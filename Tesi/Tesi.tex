...
L'obiettivo di questo capitolo è quello di dare le principali informazioni necessarie per comprendere il funzionamento del transistore MOSFET e degli effetti delle radiazioni ionizzanti su di esso.
...
\end{itemize}
Nella seconda parte si introdurranno i diversi effetti delle radiazioni ionizzanti sui dispositivi MOSFET e come mitigare questi danni, oltre a spiegare che cosa rappresenta la \textit{TID} e quali unità di misura vengono utilizzate.
