Fissato il valore della tensione $V_{DS}$, la $I_{on}$ è definita come il valore di corrente di \emph{drain} $I_D$ che attraversa un MOSFET quando il valore della tensione $V_{GS}$ è massimo:
