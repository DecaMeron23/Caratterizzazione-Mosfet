...
Un parametro utile per lo studio dell'influenza delle radiazioni ionizzanti sulla transconduttanza, è sicuramente la variazione della $g_m$ in questo caso si è scelto di calcolare la $ \% \Delta g_m$ (equazione \ref{eq:delta_gm}). Dall'espressione della transconduttanza (equazione \ref{eq:gm}) si nota la proporzionalità diretta con la mobilità dei portatori $\mu$ e della tensione di soglia $V_{th}$, entrambi influenzati dalle radiazioni ionizzanti. Nello specifico l'aumento della \textit{TID} riduce la mobilità dei portatori di carica all'interno del canale.
