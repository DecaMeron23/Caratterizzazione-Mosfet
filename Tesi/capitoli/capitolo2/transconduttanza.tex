...
Derivare dei dati discontinui porta sempre, o quasi sempre, ad avere delle curve spezzate, per le quali è difficile trovare dei valori affidabili per fare \textbf{parola che non mi viene, tipo "ragionamento" o qualche cosa simile}.
Questo è stato il caso per la transconduttanza, infatti a figura \ref{fig:gm_smooth} 
\todo[inlinepar]{da continuare}
