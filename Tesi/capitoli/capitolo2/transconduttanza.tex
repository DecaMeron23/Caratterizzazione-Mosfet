...
Calcolare la derivata di dati discontinui porta sempre, o quasi, ad ottenere delle curve spezzate, dalle quali è difficile trarre informazioni utili.
...
\begin{figure}[h]
    \centering
    % W = 100 
    \subfloat[$g_m$ senza utilizzo dello \emph{smooth}]{\includegraphics[width=0.49\textwidth]{./capitolo2/transconduttanza/estrazione_dati/gm_no_smooth.png}\label{fig:gm_smooth:no_smooth}}
    \subfloat[$g_m$ con utilizzo di \emph{smooth}]{\includegraphics[width=0.49\textwidth]{./capitolo2/transconduttanza/estrazione_dati/gm_smooth.png}\label{fig:gm_smooth:smooth}}
...
\begin{table}[h]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{c c c c c c c c c}
            \toprule
            \multirow{2}{*}{Dispositivo} & \multicolumn{8}{c}{$\%\Delta g_{m} $}                                                                                \\
            \cmidrule{2-9}
