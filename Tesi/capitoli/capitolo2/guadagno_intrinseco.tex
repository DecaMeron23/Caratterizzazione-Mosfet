...
\todo[inline]{Dare una spiegazione a questo effetto(?), e magari riscriverla meglio XD}  


\begin{figure}[ht]
    \centering
    %W = 100
    \includegraphics[width=0.49\textwidth]{./capitolo-statiche/Guadagno_Intrinseco/NMOS/pre/Guadagno_Intrinseco_W-100}
    \includegraphics[width=0.49\textwidth]{./capitolo-statiche/Guadagno_Intrinseco/NMOS/3Grad/Guadagno_Intrinseco_W-100}
    %W = 200
    \includegraphics[width=0.49\textwidth]{./capitolo-statiche/Guadagno_Intrinseco/NMOS/pre/Guadagno_Intrinseco_W-200}
    \includegraphics[width=0.49\textwidth]{./capitolo-statiche/Guadagno_Intrinseco/NMOS/3Grad/Guadagno_Intrinseco_W-200}
    %W = 600
    \includegraphics[width=0.49\textwidth]{./capitolo-statiche/Guadagno_Intrinseco/NMOS/pre/Guadagno_Intrinseco_W-600}
    \includegraphics[width=0.49\textwidth]{./capitolo-statiche/Guadagno_Intrinseco/NMOS/3Grad/Guadagno_Intrinseco_W-600}
...
\begin{figure}[ht]
    \centering
    %W = 100
    \includegraphics[width=0.49\textwidth]{./capitolo-statiche/Guadagno_Intrinseco/PMOS/pre/Guadagno_Intrinseco_W-100}
    \includegraphics[width=0.49\textwidth]{./capitolo-statiche/Guadagno_Intrinseco/PMOS/3Grad/Guadagno_Intrinseco_W-100}
    %W = 200
    \includegraphics[width=0.49\textwidth]{./capitolo-statiche/Guadagno_Intrinseco/PMOS/pre/Guadagno_Intrinseco_W-200}
    \includegraphics[width=0.49\textwidth]{./capitolo-statiche/Guadagno_Intrinseco/PMOS/3Grad/Guadagno_Intrinseco_W-200}
    %W = 600
    \includegraphics[width=0.49\textwidth]{./capitolo-statiche/Guadagno_Intrinseco/PMOS/pre/Guadagno_Intrinseco_W-600}
    \includegraphics[width=0.49\textwidth]{./capitolo-statiche/Guadagno_Intrinseco/PMOS/3Grad/Guadagno_Intrinseco_W-600}
