...
Anche per questo metodo si ritrovano le problematiche presenti per il \emph{TCM}: si deve fare il \textit{fit} di una curva ottenuta come derivata seconda e inoltre la risoluzione della $V_{GS}$ è $5mV$.
