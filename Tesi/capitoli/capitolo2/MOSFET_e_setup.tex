Per questo studio sono stati utilizzati due chip, uno composto da 9 MOSFET a canale N, l'altro composto da 9 dispositi a canale P. In entrambi i chip, tutti i dispositivi hanno il Gate spesso $28 nm$ e composto da materiali isolanti con un'alta costante dielettrica (\emph{High-K Metal Gate (HKMG) transistors}), ma avente comunque un sottilissimo strato di biossido di silicio che compone l'interfaccia con il Substrato, che è del tipo $Si/SiO_2$. \\
...
Per poter analizzare i parametri statici dei MOSFET, ad ogni livello di irraggiamenteo e dopo il processo di \emph{annealing} sono state misurate le seguenti caratteristiche:
...
\begin{table}[ht]
  ...
  \centering
	...
	\hline
      ...
      \bottomrule
    \end{tabular}
  \caption{Valori delle tensioni per la misura della caratteristica $I_D-V_{DS}$. Per i PMOS i valori hanno segno opposto rispetto a quelli riportati}
...
\begin{table}[ht]
  ...
  \centering
	...
	\cmidrule{2-5}
      ...
      \bottomrule
    \end{tabular}
  \caption{Valori delle tensioni per la misura della caratteristica $I_D-V_{GS}$. Per i PMOS i valori hanno segno opposto rispetto a quelli riportati}
