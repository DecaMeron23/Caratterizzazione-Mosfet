...
A figura \ref{fig:id_vds} vengono mostrati i grafici $I_{D} - V_{DS}$ a $V_{GS}$ pari a $450mV$, mentre a figura \ref{fig:id_vgs} sono riportati gli andamenti di della caratteristica $I_D - V_{GS}$ con $V_{DS} = 450mV$.
