...
\end{enumerate}
Mentre la prima provoca l'abbassamento della tensione di soglia, aumentando la carica positiva presente, la seconda, all'aumentare della dose assorbita, aumenta d'intensità, sovrastando il primo effetto e incrementando la presenza di elettroni all'interfaccia con conseguente aumento della $V_{th}$.  
...
Data l'esistenza di una dipendenza tra quantità di energia persa e il materiale su cui essa si deposita, spesso insieme all'unità di misura si indica anche il materiale; ad esempio, nel caso del diossido di silicio si indica $rad(SiO_{2})$. 
